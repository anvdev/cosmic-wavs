...
{/* todo: update this page. Add complete diagram of manifest, manager, trigger, component, submit, workflow, etc diagram, using EigenLayer diagrams as reference (onchain and offchain separated) all sections below link back to this new visual. */}
...
{/* add info on manifest, workflows, and manager, update aggregator section. Slim things down and link to component handbook where necessary. */}
