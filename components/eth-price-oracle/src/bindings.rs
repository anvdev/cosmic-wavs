...
pub unsafe fn _export_run_cabi<T: Guest>(arg0: *mut u8) -> *mut u8 {
    ...
    let v37 = match l6 {
        ...
        3 => {
            let e37 = {
                let l30 = *arg0.add(8 + 4 * ::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                let l31 = *arg0.add(8 + 5 * ::core::mem::size_of::<*const u8>()).cast::<usize>();
                let len32 = l31;
    ...
    let l38 = i32::from(*arg0.add(32 + 8 * ::core::mem::size_of::<*const u8>()).cast::<u8>());
    use wavs::worker::layer_types::TriggerData as V83;
    let v83 = match l38 {
        0 => {
            let e83 = {
                let l39 = *arg0.add(40 + 8 * ::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                let l40 = *arg0.add(40 + 9 * ::core::mem::size_of::<*const u8>()).cast::<usize>();
                let len41 = l40;
                let l42 =
                    *arg0.add(40 + 10 * ::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                let l43 = *arg0.add(40 + 11 * ::core::mem::size_of::<*const u8>()).cast::<usize>();
                let len44 = l43;
                let bytes44 = _rt::Vec::from_raw_parts(l42.cast(), len44, len44);
                let l45 =
                    *arg0.add(40 + 12 * ::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                let l46 = *arg0.add(40 + 13 * ::core::mem::size_of::<*const u8>()).cast::<usize>();
                let base50 = l45;
                let len50 = l46;
                ...
                let l51 =
                    *arg0.add(40 + 14 * ::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
        ...
        1 => {
            let e83 = {
                let l55 = *arg0.add(40 + 8 * ::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                let l56 = *arg0.add(40 + 9 * ::core::mem::size_of::<*const u8>()).cast::<usize>();
                let len57 = l56;
                let bytes57 = _rt::Vec::from_raw_parts(l55.cast(), len57, len57);
                let l58 = *arg0.add(40 + 10 * ::core::mem::size_of::<*const u8>()).cast::<i32>();
                let l59 =
                    *arg0.add(40 + 11 * ::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                let l60 = *arg0.add(40 + 12 * ::core::mem::size_of::<*const u8>()).cast::<usize>();
                let len61 = l60;
                let bytes61 = _rt::Vec::from_raw_parts(l59.cast(), len61, len61);
                let l62 =
                    *arg0.add(40 + 13 * ::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                let l63 = *arg0.add(40 + 14 * ::core::mem::size_of::<*const u8>()).cast::<usize>();
                let len64 = l63;
                let bytes64 = _rt::Vec::from_raw_parts(l62.cast(), len64, len64);
                let l65 =
                    *arg0.add(40 + 15 * ::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                let l66 = *arg0.add(40 + 16 * ::core::mem::size_of::<*const u8>()).cast::<usize>();
                let base73 = l65;
                let len73 = l66;
                let mut result73 = _rt::Vec::with_capacity(len73);
                for i in 0..len73 {
                    let base = base73.add(i * (4 * ::core::mem::size_of::<*const u8>()));
                    let e73 = {
                        let l67 = *base.add(0).cast::<*mut u8>();
                        let l68 = *base.add(::core::mem::size_of::<*const u8>()).cast::<usize>();
                        let len69 = l68;
                ...
                let l74 = *arg0.add(48 + 16 * ::core::mem::size_of::<*const u8>()).cast::<i64>();
        ...
        2 => {
            let e83 = {
                let l75 = *arg0.add(40 + 8 * ::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                let l76 = *arg0.add(40 + 9 * ::core::mem::size_of::<*const u8>()).cast::<usize>();
                let len77 = l76;
                let bytes77 = _rt::Vec::from_raw_parts(l75.cast(), len77, len77);
                let l78 = *arg0.add(40 + 10 * ::core::mem::size_of::<*const u8>()).cast::<i64>();
        ...
        3 => {
            let e83 = {
                let l79 = *arg0.add(40 + 8 * ::core::mem::size_of::<*const u8>()).cast::<i64>();
        ...
        n => {
            debug_assert_eq!(n, 4, "invalid enum discriminant");
            let e83 = {
                let l80 = *arg0.add(40 + 8 * ::core::mem::size_of::<*const u8>()).cast::<*mut u8>();
                let l81 = *arg0.add(40 + 9 * ::core::mem::size_of::<*const u8>()).cast::<usize>();
                let len82 = l81;
    ...
    _rt::cabi_dealloc(arg0, 56 + 16 * ::core::mem::size_of::<*const u8>(), 8);
    ...
    match result84 {
            ...
            *ptr85.add(0).cast::<u8>() = (0i32) as u8;
            match e {
                Some(e) => {
                    ...
                    *ptr85.add(16 + 1 * ::core::mem::size_of::<*const u8>()).cast::<usize>() =
                        len87;
                    *ptr85.add(16).cast::<*mut u8>() = ptr87.cast_mut();
                    match ordering86 {
                        Some(e) => {
                            *ptr85.add(16 + 2 * ::core::mem::size_of::<*const u8>()).cast::<u8>() =
                                (1i32) as u8;
                            *ptr85
        ...
        Err(e) => {
            ...
            *ptr85.add(8 + 1 * ::core::mem::size_of::<*const u8>()).cast::<usize>() = len88;
...
#[cfg(target_arch = "wasm32")]
#[unsafe(link_section = "component-type:wit-bindgen:0.41.0:wavs:worker@0.4.0-alpha.2:layer-trigger-world:encoded world")]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 17412] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xf9\x86\x01\x01A\x02\
...
avs:worker/layer-types@0.4.0-alpha.2\x05\0\x02\x03\0\0\x0etrigger-action\x03\0\x0e\
...
cosmos-chain-config\x02\x03\0\0\x09log-level\x01B\x0e\x02\x03\x02\x01\x14\x04\0\x10\
...
\0\x04\0\x03log\x01\x0a\x03\0\x04host\x05\x17\x01B\x0a\x01o\x02ss\x01p\0\x01@\0\0\
...
nt@0.2.0\x05\x18\x01B\x03\x01j\0\0\x01@\x01\x06status\0\x01\0\x04\0\x04exit\x01\x01\
\x03\0\x13wasi:cli/exit@0.2.0\x05\x19\x01B\x05\x02\x03\x02\x01\x0c\x04\0\x0cinpu\
t-stream\x03\0\0\x01i\x01\x01@\0\0\x02\x04\0\x09get-stdin\x01\x03\x03\0\x14wasi:\
cli/stdin@0.2.0\x05\x1a\x01B\x05\x02\x03\x02\x01\x0d\x04\0\x0doutput-stream\x03\0\
\0\x01i\x01\x01@\0\0\x02\x04\0\x0aget-stdout\x01\x03\x03\0\x15wasi:cli/stdout@0.\
2.0\x05\x1b\x01B\x05\x02\x03\x02\x01\x0d\x04\0\x0doutput-stream\x03\0\0\x01i\x01\
\x01@\0\0\x02\x04\0\x0aget-stderr\x01\x03\x03\0\x15wasi:cli/stderr@0.2.0\x05\x1c\
\x01B\x01\x04\0\x0eterminal-input\x03\x01\x03\0\x1dwasi:cli/terminal-input@0.2.0\
\x05\x1d\x01B\x01\x04\0\x0fterminal-output\x03\x01\x03\0\x1ewasi:cli/terminal-ou\
tput@0.2.0\x05\x1e\x02\x03\0\x0d\x0eterminal-input\x01B\x06\x02\x03\x02\x01\x1f\x04\
\0\x0eterminal-input\x03\0\0\x01i\x01\x01k\x02\x01@\0\0\x03\x04\0\x12get-termina\
l-stdin\x01\x04\x03\0\x1dwasi:cli/terminal-stdin@0.2.0\x05\x20\x02\x03\0\x0e\x0f\
terminal-output\x01B\x06\x02\x03\x02\x01!\x04\0\x0fterminal-output\x03\0\0\x01i\x01\
\x01k\x02\x01@\0\0\x03\x04\0\x13get-terminal-stdout\x01\x04\x03\0\x1ewasi:cli/te\
rminal-stdout@0.2.0\x05\"\x01B\x06\x02\x03\x02\x01!\x04\0\x0fterminal-output\x03\
\0\0\x01i\x01\x01k\x02\x01@\0\0\x03\x04\0\x13get-terminal-stderr\x01\x04\x03\0\x1e\
wasi:cli/terminal-stderr@0.2.0\x05#\x01B\x05\x01r\x02\x07secondsw\x0bnanoseconds\
y\x04\0\x08datetime\x03\0\0\x01@\0\0\x01\x04\0\x03now\x01\x02\x04\0\x0aresolutio\
n\x01\x02\x03\0\x1cwasi:clocks/wall-clock@0.2.0\x05$\x02\x03\0\x04\x05error\x02\x03\
\0\x12\x08datetime\x01Br\x02\x03\x02\x01\x0c\x04\0\x0cinput-stream\x03\0\0\x02\x03\
\x02\x01\x0d\x04\0\x0doutput-stream\x03\0\x02\x02\x03\x02\x01%\x04\0\x05error\x03\
\0\x04\x02\x03\x02\x01&\x04\0\x08datetime\x03\0\x06\x01w\x04\0\x08filesize\x03\0\
...
run\x01=\x04\0-wavs:worker/layer-trigger-world@0.4.0-alpha.2\x04\0\x0b\x19\x01\0\
