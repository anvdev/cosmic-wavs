...
In [`/evm-price-oracle/src/lib.rs`](https://github.com/Lay3rLabs/wavs-foundry-template/tree/v0.3.0/components/evm-price-oracle/src/lib.rs) you'll find the oracle service component.
