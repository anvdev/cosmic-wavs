...
Along with your component, you'll also need to define how the results of your service are submitted on-chain. With WAVS, you can use an [aggregator and submission contracts](/how-it-works#submission) to define this logic.
